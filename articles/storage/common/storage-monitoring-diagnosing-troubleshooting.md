...
È possibile scegliere le metriche orarie si desidera toodisplay in hello [portale di Azure](https://portal.azure.com) e configurare le regole di notifica agli amministratori tramite posta elettronica ogni volta che una metrica oraria supera una determinata soglia. Per altre informazioni, vedere [Ricevere notifiche di avviso](/azure/monitoring-and-diagnostics/monitoring-overview-alerts.md). 
