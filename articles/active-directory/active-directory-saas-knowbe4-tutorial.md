...
3. Nella sezione **KnowBe4 Security Awareness Training Domain and URLs** (URL e dominio KnowBe4 Security Awareness Training) seguire questa procedura:
    ...
    > [!NOTE] 
    > Poiché non è reale, Aggiornarlo con l'URL di accesso effettivo. Contattare il [team di supporto client di KnowBe4 Security Awareness Training](mailto:support@KnowBe4.com) per ottenere il valore. 
