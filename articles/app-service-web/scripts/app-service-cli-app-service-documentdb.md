...
---
# <a name="connect-a-web-app-toocosmos-db"></a>Connettersi a un tooCosmos app web DB

In questo scenario si apprenderà come un account Azure Cosmos DB toocreate e un Azure web app. Quindi si procederà al collegamento hello Cosmos DB toohello app web utilizzando le impostazioni dell'app.
...
Questo script utilizza hello seguenti comandi toocreate un gruppo di risorse, app web, DB Cosmos e tutte le relative risorse. Ogni comando in documentazione specifica toocommand hello tabella collegamenti.
...
| [az cosmosdb create](https://docs.microsoft.com/en-us/cli/azure/cosmosdb#create) | Crea un account Cosmos DB. Si tratta in cui verranno archiviati dati hello. |
| [az cosmosdb list-keys](https://docs.microsoft.com/en-us/cli/azure/cosmosdb#list-keys) | Chiavi di accesso di hello elenchi per hello specificato Cosmos DB account. |
