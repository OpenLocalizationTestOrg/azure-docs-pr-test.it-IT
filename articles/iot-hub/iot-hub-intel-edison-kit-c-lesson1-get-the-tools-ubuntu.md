...
> [!NOTE]
> Sebbene hello linguaggio della logica principale hello di programmazione C, Node.js tools vengono utilizzati in toobuild lezioni hello e distribuire applicazioni di esempio.
...
[Creare e distribuire l'applicazione di esempio hello blink][create-and-deploy-the-blink-application]
