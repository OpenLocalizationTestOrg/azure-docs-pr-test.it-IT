...
---
# <a name="connect-intel-edison-tooazure-iot-hub-nodejs"></a>Connettersi tooAzure Edison Intel IoT Hub (Node.js)
...
3. Quindi passare tutti i pacchetti hello toorun cartella repository di toohello tooinstall comando seguente, potrebbe richiedere serval minuti toocomplete.
...
### <a name="configure-and-run-hello-sample-application"></a>Configurare ed eseguire l'applicazione di esempio hello
...
1. Aprire il file di configurazione hello eseguendo hello seguenti comandi:
   ...
   Questo file contiene due macro configurabili. Hello prima uno è `INTERVAL`, che definisce l'intervallo di tempo hello tra due messaggi che inviano toocloud. Hello secondo `simulatedData`, ovvero un valore booleano per se toouse sensore dati simulati o non.
