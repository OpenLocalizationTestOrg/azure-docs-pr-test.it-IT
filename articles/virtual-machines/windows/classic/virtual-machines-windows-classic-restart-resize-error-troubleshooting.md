...
Se si verifica un errore durante il tentativo di toocreate un nuovo servizio cloud, riprovare più tardi o modificare hello area per il servizio cloud hello.
