...
3. Al prompt di accesso usare le credenziali di un utente appartenente al gruppo "AAD DC Administrators". Ad esempio, utilizziamo 'bob@domainservicespreview.onmicrosoft.com' in questo caso.
