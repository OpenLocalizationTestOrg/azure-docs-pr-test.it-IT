...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Ottenere le chiavi dell'account per Azure Cosmos DB utilizzando hello CLI di Azure
...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Crea un server logico che gli host hello Database SQL. |
