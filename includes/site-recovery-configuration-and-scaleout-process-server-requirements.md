...
| Ruoli di Windows Server | Non abilitare hello seguenti ruoli: <br> - Active Directory Domain Services <br>- Internet Information Services <br> - Hyper-V |
| **Rete** | |
| Tipo di scheda di interfaccia di rete | VMXNET3 |
| Tipo di indirizzo IP | Static |
| Accesso a Internet | server Hello deve essere in grado di tooaccess hello URL seguenti direttamente o tramite un server proxy: <br> - \*.accesscontrol.windows.net<br> - \*.backup.windowsazure.com <br>- \*.store.core.windows.net<br> - \*.blob.core.windows.net<br> - \*.hypervrecoverymanager.windowsazure.com <br> - https://cdn.mysql.com/archives/mysql-5.5/mysql-5.5.37-win32.msi (non necessario per i server di elaborazione con scalabilità orizzontale) <br> - time.nist.gov <br> - time.windows.com |
