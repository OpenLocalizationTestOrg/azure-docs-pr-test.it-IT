...
## [Lo spostamento di circuiti dal classico tooResource Manager](expressroute-move.md)
...
## Collegare un circuito ExpressRoute di tooan rete virtuale
...
## [Spostare un circuito da tooResource classico Manager](expressroute-howto-move-arm.md)
## [Eseguire la migrazione delle reti virtuali associate da tooResource classico Manager](expressroute-migration-classic-resource-manager.md)
...
### [Connettersi a un circuito tooa gateway di rete virtuale](https://azure.microsoft.com/documentation/videos/azure-expressroute-how-to-create-a-connection-between-your-vpn-gateway-and-expressroute-circuit/)
...
### [Come tooset di Peering privato per il circuito](https://azure.microsoft.com/documentation/videos/azure-expressroute-how-to-set-up-azure-private-peering-for-your-expressroute-circuit/)
