...
3. Nella casella di ricerca hello di hello Microsoft Update Catalog, immettere il numero di articolo della Knowledge Base (KB) hello di hotfix hello desiderato toodownload, ad esempio **3179904**, quindi fare clic su **ricerca**.
   
    Hello hotfix elenco viene visualizzato, ad esempio, **cumulativo Software Bundle di aggiornamento 2.2 per StorSimple 8000 Series**.
...
5. Cercare gli aggiornamenti rapidi di aggiuntivi elencate nella tabella hello precedente (**3103616**, **3146621**) e aggiungere ogni carrello toohello.
...
4. Tipo **Y** quando richiesta tooconfirm hello installazione dell'hotfix.
   ...
   > [!IMPORTANT]
   > Se l'installazione di aggiornamento 2.2, installare solo file binari di hello preceduti da 'all-hcsmdssoftwareudpate'. Non installare hello hello e ci MDS agente Aggiorna preceduto da all cismdsagentupdatebundle. Errore toodo operazione genererà un errore. 
...
1. Al termine dell'aggiornamento software hello, verificare le versioni di software di hello del sistema. Digitare:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Ripetere i passaggi da 3 a 5 tooinstall hello rimanenti hotfix in modalità normale.
   
   * aggiornamento di iSCSI Hello KB3146621
   * aggiornamento WMI Hello KB3103616
3. Ignorare questo passaggio se si aggiorna da Update 2. Se si sta aggiornando un tooUpdate precedente versione 2, è necessario anche toodownload:

    - driver Hello LSI KB3121900

    - aggiornamento di Spaceport Hello KB3090322

    - aggiornamento di Storport Hello KB3080728
