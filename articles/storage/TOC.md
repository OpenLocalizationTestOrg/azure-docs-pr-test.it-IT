...
### [Collegare una macchina virtuale Windows di tooa disco gestito con PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [L'accesso anonimo tooblobs](storage-manage-access-to-resources.md)
...
### [Eseguire la migrazione di dischi gestiti tooAzure di macchine virtuali di Azure](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Eseguire la migrazione da AWS e altri dischi tooManaged](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migrazione tooPremium archiviazione usando Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Eseguire la migrazione di archiviazione tooPremium](storage-migration-to-premium-storage.md)
...
### [Utilizzare hello emulatore di archiviazione](storage-use-emulator.md)
...
### [Risolvere gli errori relativi all'eliminazione del disco](storage-resource-manager-cannot-delete-storage-account-container-vhd.md)
### [Risolvere i problemi relativi all'archiviazione di file](storage-troubleshoot-file-connection-problems.md)
## Trasferire i dati
### [Spostare dati tooand dall'archiviazione](storage-moving-data.md)
### [AzCopy in Windows](storage-use-azcopy.md)
### [AzCopy in Linux](storage-use-azcopy-linux.md)
### [Tramite il servizio di importazione/esportazione hello](storage-import-export-service.md)
### [Utilizzando lo strumento di importazione/esportazione hello](storage-import-export-tool-how-to.md)
#### [Impostazione di hello strumento di importazione/esportazione](storage-import-export-tool-setup.md)
...
##### [Quick reference for frequently used commands for import jobs](storage-import-export-tool-quick-reference.md) (Riferimento rapido per i comandi usati più di frequente per i processi di importazione)
...
#### [Risoluzione dei problemi hello strumento di importazione/esportazione](storage-import-export-tool-troubleshooting-v1.md)
...
### [Utilizzando lo strumento di importazione/esportazione (v1) hello](storage-import-export-tool-how-to-v1.md)
#### [Impostazione di hello strumento di importazione/esportazione](storage-import-export-tool-setup-v1.md)
...
#### [Formato di file di proprietà e metadati del servizio Importazione/Esportazione](storage-import-export-file-format-metadata-and-properties.md)
#### [Formato file log del servizio Importazione/Esportazione](storage-import-export-file-format-log.md)
### [Tramite l'API REST del servizio importazione/esportazione di Azure hello](storage-import-export-using-the-rest-api.md)
...
# Risorse
## [Roadmap per Azure](https://azure.microsoft.com/roadmap/?category=storage)
