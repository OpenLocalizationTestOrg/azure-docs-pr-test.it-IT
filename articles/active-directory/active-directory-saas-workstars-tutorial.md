...
In questa esercitazione, è illustrato come toointegrate Workstars con Azure Active Directory (Azure AD).

Integrazione Workstars con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooWorkstars.
- È possibile abilitare l'utenti tooautomatically get connesso tooWorkstars (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Workstars tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Workstars dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-workstars-from-hello-gallery"></a>Aggiunta di Workstars dalla raccolta hello
integrazione hello tooconfigure di Workstars in Azure AD, è necessario tooadd Workstars dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Workstars dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Workstars**selezionare **Workstars** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Workstars è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Workstars deve toobe stabilita.

In Workstars, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Workstars, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Workstars](#create-a-workstars-test-user)**  -toohave un equivalente di Britta Simon in Workstars che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Workstars.

**Azure AD tooconfigure single sign-on con Workstars, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Workstars** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Workstars dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **identificatore** casella di testo, digitare l'URL hello:`https://workstars.com`

    b. In hello **URL di risposta** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<subdomain>.workstars.com/saml/login_check`

    > [!NOTE] 
    > il valore di Hello non è di tipo real. Il valore di hello aggiornamento con hello URL di risposta effettivo. Contatto [team di supporto Workstars](https://support.workstars.com) valore hello tooget.
...
6. In hello **Workstars configurazione** fare clic su **configurare Workstars** tooopen **Configura sign-on** finestra. Hello copia **Sign-Out URL, l'ID entità SAML e SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**

    ![Configurazione di Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_configure.png) 

7. In un'altra finestra del browser, accedere come amministratore nel sito della società di tooyour Workstars.

8. Nella barra degli strumenti principale hello, fare clic su **impostazioni**.

    ![Impostazioni di Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_sett.png)

9. Andare troppo**Sign On** > **impostazioni**.
...
10. In hello **Single Sign in (SAML) - impostazioni** eseguire hello alla procedura seguente:
    ...
    c. Copiare il contenuto di hello del file di certificato scaricato hello nel blocco note e quindi incollarlo hello **x509 certificato** casella di testo. 

    d. In hello **URL SSO SAML** casella di testo, hello Incolla valore **SAML Single Sign-On Service URL**, che è stato copiato dal portale di Azure.
...
In questa sezione viene creato un utente di nome Britta Simon in Workstars. Lavorare con [Workstars team di supporto](https://support.workstars.com) utenti hello tooadd nella piattaforma Workstars hello.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooWorkstars.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooWorkstars, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Workstars**.
...
Quando si fa clic hello Workstars riquadro in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour Workstars applicazione.
