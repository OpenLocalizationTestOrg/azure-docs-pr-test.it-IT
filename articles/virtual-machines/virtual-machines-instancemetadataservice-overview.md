...
platformUpdateDomain |  [Dominio di aggiornamento](virtual-machines-windows-manage-availability.md) hello macchina virtuale è in esecuzione in
platformFaultDomain | [Dominio di errore](virtual-machines-windows-manage-availability.md) hello macchina virtuale è in esecuzione in
...
- Altre informazioni su hello [scheduledevents](virtual-machines-scheduled-events.md) API **In anteprima pubblica** fornita da servizio metadati dell'istanza di hello.
