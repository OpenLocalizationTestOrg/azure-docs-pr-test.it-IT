...
In questa esercitazione, è illustrato come toointegrate Zscaler Beta con Azure Active Directory (Azure AD).

Integrazione di Zscaler Beta con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooZscaler Beta
- È possibile abilitare l'utenti tooautomatically get connesso tooZscaler Beta (Single Sign-On) con i propri account Azure AD
...
tooconfigure integrazione di Azure AD con Zscaler Beta, è necessario hello seguenti elementi:
...
1. Aggiunta di Zscaler Beta dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-zscaler-beta-from-hello-gallery"></a>Aggiunta di Zscaler Beta dalla raccolta hello
integrazione hello tooconfigure di Zscaler Beta in Azure AD, è necessario tooadd Zscaler Beta dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Zscaler Beta dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Zscaler Beta**.
...
5. Nel riquadro dei risultati hello, selezionare **Zscaler Beta**, quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Zscaler Beta è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Zscaler Beta deve toobe stabilita.

In Zscaler Beta, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e test Azure single sign-on AD con Zscaler Beta, è necessario hello toocomplete seguenti blocchi predefiniti:
...
4. **[Creazione di un utente di test di Zscaler Beta](#creating-a-zscaler-beta-test-user)**  -toohave un equivalente di Britta Simon in Zscaler Beta che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Zscaler Beta.

**Azure AD tooconfigure single sign-on con Zscaler Beta, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Zscaler Beta** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Zscaler Beta dominio e gli URL** seguire hello alla procedura seguente:

    ![Configura accesso Single Sign-On](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)

    Nella casella di testo URL hello Sign-on, digitare l'URL di hello usato da tooyour il toosign a utenti dell'applicazione Zscaler Beta.

    > [!NOTE] 
    > Si dispone di tooupdate questo valore con hello URL effettivo Sign-On. Contatto [team di supporto di Zscaler Beta Client](https://www.zscaler.com/company/contact) tooget questo valore. 
...
6. In hello **Zscaler Beta configurazione** fare clic su **configurare Zscaler Beta** tooopen **Configura sign-on** finestra. Hello copia **SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**

    ![Configura accesso Single Sign-On](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 

7. In una finestra del web browser, accedere tooyour sito della società Zscaler Beta come amministratore.
...
5. Nella sezione server Proxy hello, eseguire hello alla procedura seguente:   
    ...
    b. Nella casella di testo indirizzo hello digitare **gateway.zscalerbeta.net**.
...
toolog agli utenti di Azure AD tooenable in tooZscaler Beta, devono essere sottoposte a provisioning tooZscaler Beta. Nel caso di hello di Zscaler Beta, il provisioning è un'attività manuale.
...
1. Accedi tooyour **Zscaler Beta** tenant.
...
> [!NOTE]
> È possibile usare qualsiasi altro Zscaler Beta utente account strumento di creazione o le API fornite da Zscaler Beta tooprovision degli account utente di Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Assegnazione utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooZscaler Beta.

![Assegna utente][200] 

**tooassign Britta Simon tooZscaler Beta, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Zscaler Beta**.
...
Quando si fa clic hello Zscaler Beta riquadro in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour applicazione Zscaler Beta.
