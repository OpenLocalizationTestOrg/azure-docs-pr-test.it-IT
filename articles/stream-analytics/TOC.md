...
### [Funzioni di output tooAzure](stream-analytics-functions-redis.md)
### [Archivio Lake di output tooData](stream-analytics-data-lake-output.md)
### [Output tooDocumentDB](stream-analytics-documentdb-output.md)
...
### [Velocità effettiva tooincrease scala](stream-analytics-scale-jobs.md)
...
### [Utilizzare hello Management .NET SDK](stream-analytics-dotnet-management-sdk.md)
