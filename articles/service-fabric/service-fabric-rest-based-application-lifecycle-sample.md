...
Questo esempio viene illustrato ciclo di vita di hello Service Fabric applicazione tramite chiamate all'API REST. Per ulteriori informazioni sul ciclo di vita dell'applicazione hello Service Fabric, vedere [il ciclo di vita di Service Fabric applicazione](service-fabric-application-lifecycle.md).

In questo esempio esegue l'esempio hello:

* Hello disposizioni **WordCount 1.0.0** esempio dal pacchetto di applicazione WordCount hello in archivio immagini hello.
* Consente di visualizzare hello elenco dei tipi di applicazioni, che include WordCount 1.0.0.
* Consente di creare applicazione WordCount hello **fabric: / WordCount**.
* Visualizza l'elenco hello delle applicazioni, che include fabric: / WordCount versione 1.0.0.
* Versione di hello 1.1.0 esegue il provisioning dell'esempio WordCount hello hello **WordCountUpgrade** pacchetto dell'applicazione nell'archivio immagini hello.
* Visualizza l'elenco hello di tipi di applicazioni, che include entrambi WordCount 1.0.0 e **WordCount 1.1.0**.
* Aggiorna tooversion di applicazione WordCount hello 1.1.0.
* Visualizza hello l'elenco di applicazioni, che include WordCount versione 1.1.0, ma non è più WordCount versione 1.0.0.
* Elimina applicazione WordCount hello.
* Visualizza l'elenco hello delle applicazioni, che non include più fabric: / WordCount.
* Versione di hello 1.1.0 Annulla il provisioning di esempio WordCount hello.
* Visualizza elenco hello di tipi di applicazioni, che include WordCount 1.0.0, ma non è più WordCount 1.1.0.
* Versione di hello 1.0.0 Annulla il provisioning di esempio WordCount hello.
* Visualizza elenco hello di tipi di applicazioni, che non include più WordCount.

## <a name="prerequisites"></a>Prerequisiti
In questo esempio utilizza hello [esempio WordCount](http://aka.ms/servicefabricsamples) (trovato nell'hello **Introduzione** esempi). Esempio WordCount Hello deve essere compilato per primi e quindi due pacchetti di applicazioni devono essere copiato toohello archivio di immagini.

| Cartella | Descrizione |
| --- | --- |
| WordCount |applicazione di esempio WordCount Hello. Hello **ApplicationManifest.xml** contiene file **ApplicationTypeVersion = "1.0.0"**. |
| WordCountUpgrade |applicazione di esempio WordCount Hello. file ApplicationManifest XML Hello devono essere modificate troppo**ApplicationTypeVersion = "1.1.0"** tooallow hello applicazione aggiornamento toooccur. |

toocreate hello pacchetti di applicazioni e copiarli archivio immagini toohello, richiedere hello alla procedura seguente:

1. Copia **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** troppo**C:\Temp\WordCount**. Crea pacchetto dell'applicazione WordCount hello.
2. Copiare C:\Temp\WordCount troppo**C:\Temp\WordCountUpgrade**. Questo crea hello **WordCountUpgrade applicazione** pacchetto.
3. Aprire **C:\Temp\WordCountUpgrade\ApplicationManifest.xml** in un editor di testo.
4. In hello **ApplicationManifest** elemento, modifica hello **ApplicationTypeVersion** attributo troppo**"1.1.0"**.  Aggiorna numero di versione di hello di un'applicazione hello.
5. Salvare file ApplicationManifest XML hello modificato.
6. Eseguire lo script di PowerShell come amministratore seguente hello toocopy hello applicazioni toohello image store:
...
Al termine dell'esecuzione hello script di PowerShell, l'applicazione è pronta toorun.

## <a name="example"></a>Esempio
Hello di esempio seguente viene illustrato il ciclo di vita di hello Service Fabric applicazione.
