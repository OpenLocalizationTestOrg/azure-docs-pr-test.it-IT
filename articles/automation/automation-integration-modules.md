---
title: Creare un modulo di integrazione di Automazione di Azure | Documentazione Microsoft
...
2. Se il modulo viene eseguito su un sistema remoto:
    ...
    a. deve contenere un file di metadati del modulo di integrazione che definisce le informazioni necessarie per connettersi al sistema remoto, ovvero il tipo di connessione.  
    b. Ogni cmdlet del modulo, inoltre, deve poter accettare un oggetto connessione (ovvero un'istanza del tipo di connessione) come parametro.  
