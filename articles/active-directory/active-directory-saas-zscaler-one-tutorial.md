...
In questa esercitazione, è illustrato come toointegrate Zscaler One con Azure Active Directory (Azure AD).

Integrazione di Zscaler One con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooZscaler uno
- È possibile abilitare l'utenti tooautomatically get connesso tooZscaler uno (Single Sign-On) con i propri account Azure AD
...
integrazione di Azure AD con Zscaler One tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Zscaler One dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-zscaler-one-from-hello-gallery"></a>Aggiunta di Zscaler One dalla raccolta hello
integrazione hello tooconfigure di Zscaler One in Azure AD, è necessario tooadd Zscaler One dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Zscaler One dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Zscaler One**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_search.png)

5. Nel riquadro dei risultati hello, selezionare **Zscaler One**, quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Zscaler One è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Zscaler One deve toobe stabilita.

In Zscaler One, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e test Azure single sign-on AD con Zscaler One, è necessario hello toocomplete seguenti blocchi predefiniti:
...
4. **[Creazione di un utente test Zscaler One](#creating-a-zscaler-one-test-user)**  -toohave un equivalente di Britta Simon in Zscaler One che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Zscaler One.

**Azure AD tooconfigure single sign-on con Zscaler One, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Zscaler One** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Zscaler un dominio e gli URL** seguire hello alla procedura seguente:

    ![Configura accesso Single Sign-On](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_url.png)

    Nella casella di testo URL accesso hello digitare l'URL di hello usato da tooyour il toosign a utenti dell'applicazione Zscaler One.

    > [!NOTE] 
    > Si dispone di tooupdate questo valore con hello URL effettivo Sign-On. Contatto [team di supporto di Zscaler un Client](https://www.zscaler.com/company/contact) tooget questi valori.
...
6. In hello **una configurazione di Zscaler** fare clic su **configurare Zscaler One** tooopen **Configura sign-on** finestra. Hello copia **SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**

    ![Configura accesso Single Sign-On](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. In una finestra del web browser, accedere come amministratore nel sito della società Zscaler One tooyour.
...
toolog agli utenti di Azure AD tooenable in tooZscaler uno, devono essere sottoposte a provisioning tooZscaler uno. Nel caso di hello di Zscaler One, il provisioning è un'attività manuale.
...
1. Accedi tooyour **Zscaler One** tenant.
...
3. Fare clic su **User Management**.   
     ...
     ![Aggiungi](./media/active-directory-saas-zscaler-one-tutorial/ic781036.png "Aggiungi")
...
> [!NOTE]
> È possibile usare qualsiasi altro Zscaler One account strumento di creazione utente o le API fornite da Zscaler One tooprovision degli account utente di Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Assegnazione utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooZscaler uno.

![Assegna utente][200] 

**tooassign tooZscaler Britta Simon uno, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Zscaler One**.
...
Quando si fa clic su riquadro di Zscaler One hello in hello Pannello di accesso, è necessario ottenere applicazione Zscaler One tooyour automaticamente firmato-on.
