...
Quando il reparto IT richiede toostart utilizzando la verifica in due passaggi, si noterà una schermata che indica che **l'amministratore ha richiesto di impostare questo account per la verifica di protezione aggiuntive**:
