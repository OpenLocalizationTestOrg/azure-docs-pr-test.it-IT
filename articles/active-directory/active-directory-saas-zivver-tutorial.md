...
In questa esercitazione, è illustrato come toointegrate ZIVVER con Azure Active Directory (Azure AD).

Integrazione ZIVVER con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooZIVVER.
- È possibile abilitare l'utenti tooautomatically get connesso tooZIVVER (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con ZIVVER tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di ZIVVER dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-zivver-from-hello-gallery"></a>Aggiunta di ZIVVER dalla raccolta hello
integrazione hello tooconfigure di ZIVVER in Azure AD, è necessario tooadd ZIVVER dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd ZIVVER dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **ZIVVER**selezionare **ZIVVER** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in ZIVVER è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in ZIVVER deve toobe stabilita.

In ZIVVER, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con ZIVVER, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test ZIVVER](#create-a-zivver-test-user)**  -toohave un equivalente di Britta Simon in ZIVVER che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione ZIVVER.

**Azure AD tooconfigure single sign-on con ZIVVER, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **ZIVVER** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **ZIVVER dominio e gli URL** seguire hello alla procedura seguente:
    ...
    In hello **identificatore** casella di testo, digitare l'URL hello:`https://app.zivver.com/SAML/Zivver`
...
6. tooconfigure single sign-on sul **ZIVVER** lato, è necessario hello toosend scaricato **Metadata XML** troppo[ZIVVER team di supporto](https://support.zivver.com). Impostano questo hello toohave impostazione connessione SAML SSO impostato correttamente su entrambi i lati.
...
In questa sezione viene creato un utente di nome Britta Simon in ZIVVER. Lavorare con [ZIVVER team di supporto](https://support.zivver.com) utenti hello tooadd nella piattaforma ZIVVER hello.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooZIVVER.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooZIVVER, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **ZIVVER**.
...
Quando si fa clic hello ZIVVER riquadro in hello Pannello di accesso, è necessario ottenere applicazione ZIVVER tooyour automaticamente firmato-on.
