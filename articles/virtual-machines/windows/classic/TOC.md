...
# Attività iniziali
## [Creare una macchina virtuale tramite il portale di hello](tutorial.md)
## [Accedere tooa VM](connect-logon.md)
...
## Rete
### [Come tooset degli endpoint](setup-endpoints.md)
### [Connettere VM a una rete virtuale o a un servizio cloud](connect-vms.md)
### [Connettere reti virtuali classiche tooResource Manager VNets](../../../vpn-gateway/vpn-gateway-connect-different-deployment-models-powershell.md)
...
## Configurare
### [Reimpostare una password o hello il servizio Desktop remoto](../../virtual-machines-windows-reset-rdp.md)
...
### [Ridimensiona una macchina virtuale Windows creata nel modello di distribuzione classica hello](resize-vm.md)
### [Manutenzione](planned-maintenance-schedule.md)

## Gestisci
### [Eseguire la migrazione dalla versione classica tooResource Manager](../../virtual-machines-windows-migration-classic-resource-manager-deep-dive.md)
### [Gestire le VM con Azure PowerShell](manage-psh.md)
### [Sulle estensioni e agente VM hello](agents-and-extensions.md)
...
#### [Configurare le applicazioni MPI toorun un cluster](hpcpack-rdma-cluster.md)
#### [Eseguire carichi di lavoro di Excel e SOA](../../virtual-machines-windows-excel-cluster-hpcpack.md)
#### [Crea hello del nodo head con un'immagine del Marketplace](../../virtual-machines-windows-hpcpack-cluster-headnode.md)
#### [Inviare i processi da tooAzure locale](../../virtual-machines-windows-hpcpack-cluster-submit-jobs.md)
...
### [Applicazione di accesso tooan](../../virtual-machines-windows-troubleshoot-app-connection.md)
