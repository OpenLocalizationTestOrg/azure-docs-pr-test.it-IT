...
> [!IMPORTANT]
> Microsoft consiglia di gestire Azure AD usando l'[interfaccia di amministrazione di Azure AD](https://aad.portal.azure.com) nel portale di Azure invece di usare il portale di Azure classico citato nel presente articolo. Per informazioni su come assegnare ruoli di amministratore nel centro di amministrazione di Azure AD, vedere [Concedere una licenza a se stessi e agli utenti in Azure AD](active-directory-licensing-get-started-azure-portal.md).
