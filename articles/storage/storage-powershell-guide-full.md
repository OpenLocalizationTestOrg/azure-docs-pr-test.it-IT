...
Per altre informazioni, vedere [Uso delle firme di accesso condiviso (SAS)](storage-dotnet-shared-access-signature-part-1.md) e [Gestire l'accesso in lettura anonimo a contenitori e BLOB](storage-manage-access-to-resources.md).
