...
In questa esercitazione, è illustrato come toointegrate Evidence.com con Azure Active Directory (Azure AD).

Integrazione Evidence.com con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooEvidence.com.
- È possibile abilitare l'utenti tooautomatically get connesso tooEvidence.com (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Evidence.com tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Evidence.com dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-evidencecom-from-hello-gallery"></a>Aggiunta di Evidence.com dalla raccolta hello
integrazione hello tooconfigure di Evidence.com in Azure AD, è necessario tooadd Evidence.com dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Evidence.com dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Evidence.com**selezionare **Evidence.com** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Evidence.com è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Evidence.com deve toobe stabilita.

In Evidence.com, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Evidence.com, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Evidence.com](#create-a-evidencecom-test-user)**  -toohave un equivalente di Britta Simon in Evidence.com che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Evidence.com.

**Azure AD tooconfigure single sign-on con Evidence.com, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Evidence.com** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Evidence.com dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **Sign-on URL** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<yourtenant>.evidence.com`

    b. In hello **identificatore** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<yourtenant>.evidence.com`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo URL di accesso e l'identificatore. Contatto [team di supporto Evidence.com Client](https://communities.taser.com/support/SupportContactUs?typ=LE) tooget questi valori. 
...
6. In hello **Evidence.com configurazione** fare clic su **configurare Evidence.com** tooopen **Configura sign-on** finestra. Hello copia **Sign-Out URL, l'ID entità SAML e SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**

    ![Configurazione di Evidence.com](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_configure.png) 

7. In una finestra del browser web separato, account di accesso tooyour Evidence.com tenant come amministratore e passare troppo**Admin** scheda

8. Fare clic su **Agency Single Sign On**

9. Selezionare **SAML Based Single Sign On**

10. Hello copia **ID entità SAML**, **SAML Single Sign-On Service URL** e **Sign-Out URL** i valori mostrati nei campi corrispondenti toohello Evidence.com e di hello portale di Azure.

11. Aprire il file Certificate(Base64) scaricato nel blocco note, hello copia del contenuto di esso negli Appunti e quindi incollarlo toohello **certificato di sicurezza** casella. 

12. Salvare la configurazione di hello in Evidence.com.
...
Per Azure AD utenti toobe in grado di toosign in è necessario eseguirne il provisioning per l'accesso all'interno di hello Evidence.com applicazione. In questa sezione viene descritto come degli account utente di Azure AD toocreate all'interno di Evidence.com

**un account utente in Evidence.com tooprovision:**

1. In una finestra del Web browser accedere al sito aziendale Evidence.com come amministratore.

2. Passare troppo**Admin** scheda.

3. Fare clic su **Add User**.

4. Fare clic su hello **Aggiungi** pulsante.

5. Hello **indirizzo di posta elettronica** di hello aggiunto l'utente deve corrispondere hello nome utente di utenti hello in Azure AD che si desiderano toogive accesso. Se l'indirizzo di posta elettronica e il nome utente hello non sono hello stesso valore all'interno dell'organizzazione, è possibile utilizzare hello **Evidence.com > attributi > Single Sign-On** sezione di hello toochange portale Azure hello nameidenitifer inviati indirizzo di posta elettronica tooEvidence.com toobe hello.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooEvidence.com.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooEvidence.com, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Evidence.com**.
...
Quando si fa clic su riquadro Evidence.com hello in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour Evidence.com applicazione.
