...
## [Utilizzare l'API di Azure AD Graph hello](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Hello personalizzazione dell'interfaccia utente](active-directory-b2c-reference-ui-customization.md)
...
## [Utilizzare hello reporting API](active-directory-b2c-reference-usage-reporting-api.md)
