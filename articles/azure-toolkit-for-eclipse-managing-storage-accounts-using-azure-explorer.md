...
---
# <a name="manage-storage-accounts-by-using-hello-azure-explorer-for-eclipse"></a>Gestire gli account di archiviazione tramite hello Azure Explorer per Eclipse

Hello Esplora Azure, che fa parte di hello Azure Toolkit per Eclipse, fornisce agli sviluppatori di Java con una soluzione da usare per la gestione degli account di archiviazione nel proprio account da Azure all'interno di ambiente di sviluppo integrato (IDE) di hello Eclipse.
...
3. In hello **crea Account di archiviazione** finestra di dialogo specificare hello le opzioni seguenti:
   ...
   * **Area**: Specifica il percorso di hello in cui verranno creati account di archiviazione (ad esempio, "Stati Uniti occidentali").
...
4. Dopo aver specificato tutti hello opzioni precedenti, fare clic su **crea**.
...
1. In hello **Esplora Azure** visualizzare, fare doppio clic su account di archiviazione hello in cui si desidera toocreate un contenitore e quindi fare clic su **crea contenitore blob**.
...
1. In hello **Esplora Azure** consente di visualizzare, fare doppio clic su contenitore di archiviazione hello e quindi fare clic su **eliminare**.

   ![Comando Elimina contenitore di archiviazione][DC01]

2. Nella finestra di conferma hello, fare clic su **OK**.
...
1. In hello **Esplora Azure** consente di visualizzare, fare doppio clic su account di archiviazione hello e quindi fare clic su **eliminare**.
