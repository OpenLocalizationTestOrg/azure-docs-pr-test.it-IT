...
> [!IMPORTANT]
> Prima di rimozione e sostituzione di un PCM, esaminare le informazioni di sicurezza hello in [sostituzione dei componenti hardware StorSimple](storsimple-8000-hardware-component-replacement.md).
...
1. Nel portale di Azure classico hello, fare clic su **Impostazioni > monitoraggio > stato di Hardware**. Controllare lo stato di hello dei componenti PCM hello sotto **dei componenti condivisi di** tooidentify quello non funzionante:
...
8. Verifica della corretta sostituzione hello: nel portale di Azure del servizio di gestione di dispositivi StorSimple hello, spostarsi tooyour dispositivo e quindi troppo**Impostazioni > monitoraggio > stato di Hardware**. In hello **dei componenti condivisi di**, stato hello di hello PCM deve essere di colore verde.
