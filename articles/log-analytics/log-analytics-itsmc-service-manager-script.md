...
---
# <a name="create-service-manager-web-app-using-the-automated-script-preview"></a><span data-ttu-id="4bc9d-103">Creare un'app Web di Service Manager con lo script automatizzato (Anteprima)</span><span class="sxs-lookup"><span data-stu-id="4bc9d-103">Create Service Manager Web app using the automated script (Preview)</span></span>

<span data-ttu-id="4bc9d-104">Usare lo script seguente per creare l'app Web per l'istanza di Service Manager.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-104">Use the following script to create the Web app for your Service Manager instance.</span></span> <span data-ttu-id="4bc9d-105">Altre informazioni sulla connessione di Service Manager sono reperibili qui: [Service Manager Web app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service) (App Web di Service Manager)</span><span class="sxs-lookup"><span data-stu-id="4bc9d-105">More information about Service Manager connection is here: [Service Manager Web app](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)</span></span>

<span data-ttu-id="4bc9d-106">Eseguire lo script, fornendo i dettagli richiesti seguenti:</span><span class="sxs-lookup"><span data-stu-id="4bc9d-106">Run the script by providing the following required details:</span></span>

- <span data-ttu-id="4bc9d-107">Dettagli della sottoscrizione di Azure</span><span class="sxs-lookup"><span data-stu-id="4bc9d-107">Azure subscription details</span></span>
- <span data-ttu-id="4bc9d-108">Nome del gruppo di risorse</span><span class="sxs-lookup"><span data-stu-id="4bc9d-108">Resource group name</span></span>
- <span data-ttu-id="4bc9d-109">Località</span><span class="sxs-lookup"><span data-stu-id="4bc9d-109">Location</span></span>
- <span data-ttu-id="4bc9d-110">Dettagli del server di Service Manager (nome del server, dominio, nome utente e password)</span><span class="sxs-lookup"><span data-stu-id="4bc9d-110">Service Manager server details (server name,    domain, username and password)</span></span>
- <span data-ttu-id="4bc9d-111">Prefisso del nome del sito per l'app Web</span><span class="sxs-lookup"><span data-stu-id="4bc9d-111">Site name prefix for your Web app</span></span>
- <span data-ttu-id="4bc9d-112">Spazio dei nomi ServiceBus.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-112">ServiceBus Namespace.</span></span>

<span data-ttu-id="4bc9d-113">Lo script creerà l'app Web usando il nome specificato insieme ad alcune stringhe aggiuntive per renderlo univoco.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-113">The script will create the Web app using the name that you specified (along with few additional strings to make it unique).</span></span> <span data-ttu-id="4bc9d-114">Genera **URL dell'app Web**, **ID del client** e **segreto client**.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-114">It generates the **Web app URL**, **client ID** and **client secret**.</span></span>

<span data-ttu-id="4bc9d-115">Salvare questi valori in quanto serviranno per la creazione di una connessione con IT Service Management Connector.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-115">Save these values, you will need these when you create a connection with IT Service Management Connector.</span></span>

## <a name="prerequisites"></a><span data-ttu-id="4bc9d-116">Prerequisiti</span><span class="sxs-lookup"><span data-stu-id="4bc9d-116">Prerequisites</span></span>

 <span data-ttu-id="4bc9d-117">Windows Management Framework 5.0 o versione successiva.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-117">Windows Management Framework 5.0 or above.</span></span>
<span data-ttu-id="4bc9d-118">Per impostazione predefinita, Windows 10 ha la versione 5.1.</span><span class="sxs-lookup"><span data-stu-id="4bc9d-118">Windows 10 has 5.1 by default.</span></span> <span data-ttu-id="4bc9d-119">È possibile scaricare il framework da [qui](https://www.microsoft.com/download/details.aspx?id=53347):</span><span class="sxs-lookup"><span data-stu-id="4bc9d-119">You can download the framework from [here](https://www.microsoft.com/download/details.aspx?id=53347):</span></span>

<span data-ttu-id="4bc9d-120">Usare lo script seguente:</span><span class="sxs-lookup"><span data-stu-id="4bc9d-120">Use the following script:</span></span>
...
```
## <a name="next-steps"></a><span data-ttu-id="4bc9d-121">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="4bc9d-121">Next steps</span></span>
<span data-ttu-id="4bc9d-122">[Configurazione della connessione ibrida](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span><span class="sxs-lookup"><span data-stu-id="4bc9d-122">[Configure the Hybrid connection](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).</span></span>
