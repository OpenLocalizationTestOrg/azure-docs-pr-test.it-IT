...
**Tipo di archiviazione:** Managed Disks offre due livelli di prestazioni, [Premium](storage-premium-storage.md), basato su unità SSD, e [Standard](storage-standard-storage.md), basato su unità disco rigido. la fatturazione di un disco gestito Hello dipende il tipo di archiviazione selezionato per il disco di hello.
...
[Snapshot incrementali](storage-incremental-snapshots.md) non sono attualmente supportate per i dischi gestiti, ma sarà supportato in hello future.
...
* [Come toocapture un'immagine gestita di una macchina virtuale generalizzata in Azure](../virtual-machines/windows/capture-image-resource.md)
* [Come toogeneralize e acquisire una macchina virtuale Linux utilizzando hello Azure CLI 2.0](../virtual-machines/linux/capture-image.md)
...
* [Collegare un tooa disco dati gestiti macchina virtuale di Windows con PowerShell](../virtual-machines/windows/attach-disk-ps.md)

* [Aggiungere una VM Linux di tooa disco gestito](../virtual-machines/linux/add-disk.md)
...
* [Eseguire la migrazione da altre piattaforme e AWS tooManaged dischi in Azure](../virtual-machines/windows/on-prem-to-azure.md)

* [Convertire i dischi di macchine virtuali di Azure toomanaged in Azure](../virtual-machines/windows/migrate-to-managed-disks.md)
