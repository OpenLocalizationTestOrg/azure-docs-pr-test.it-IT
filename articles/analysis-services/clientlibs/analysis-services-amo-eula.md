...
---
# <a name="analysis-services-amo-redistributable-package-end-user-license-agreement-eula"></a>Contratto di licenza con l'utente finale di Analysis Services AMO Redistributable Package
...
1.  **INSTALLAZIONE E DIRITTI SULL'UTILIZZO.**
    ...
    **a)    Generale.** Il licenziatario potrà installare e utilizzare un numero qualsiasi di copie del software.

    **b)    Software di Terzi.** Il software potrà contenere applicazioni di terzi che Microsoft, non i terzi, concede in licenza al licenziatario ai sensi del presente contratto. Eventuali comunicazioni relative alle applicazioni di terzi sono incluse solo a scopo informativo.
...
2.  **CODICE DISTRIBUIBILE.** Il software potrà contenere codice che il licenziatario è autorizzato a distribuire (ad esempio, rendere disponibile a terzi) in applicazioni che sviluppa, come descritto nel presente Articolo.
    ...
    **i.**  File REDIST.TXT. Il licenziatario potrà duplicare e distribuire il formato in codice oggetto del codice elencato nell'eventuale elenco REDIST nel software o nel file Redist.txt;

    **ii.** Libreria di Immagini. Il licenziatario potrà duplicare e distribuire le immagini, i grafici e le animazioni presenti nella libreria di immagini come descritto nella documentazione del software e
