...
---
# <a name="how-to-expand-the-os-drive-of-a-virtual-machine-in-an-azure-resource-group"></a><span data-ttu-id="fc745-103">Come espandere l'unità del sistema operativo di una macchina virtuale in un gruppo di risorse di Azure</span><span class="sxs-lookup"><span data-stu-id="fc745-103">How to expand the OS drive of a Virtual Machine in an Azure Resource Group</span></span>
