...
In questa esercitazione, è illustrato come toointegrate Envoy con Azure Active Directory (Azure AD).

Invio di integrazione con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooEnvoy.
- È possibile abilitare l'utenti tooautomatically get connesso tooEnvoy (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Envoy tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di invio dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-envoy-from-hello-gallery"></a>Aggiunta di invio dalla raccolta hello
integrazione hello tooconfigure di invio in Azure AD, è necessario tooadd Envoy dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Envoy dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Envoy**selezionare **Envoy** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Envoy è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Envoy richiede toobe stabilita.

In Envoy, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e test Azure single sign-on AD con Envoy, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Envoy](#create-an-envoy-test-user)**  -toohave un equivalente di Britta Simon in Envoy che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione di invio.

**Azure AD tooconfigure single sign-on con Envoy, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Envoy** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Envoy dominio e gli URL** seguire hello alla procedura seguente:
    ...
    In hello **Sign-on URL** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<tenant-name>.Envoy.com`
    
    > [!NOTE] 
    > Poiché non è reale, Aggiorna il valore con hello URL effettivo Sign-On. Contatto [team di supporto Client Envoy](https://envoy.com/contact/) tooget questo valore.
...
6. In hello **Envoy configurazione** fare clic su **configurare Envoy** tooopen **Configura sign-on** finestra. Hello copia **SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**
...
11. In hello **SAML Authentication** configurazione seguire hello alla procedura seguente:

    ![Autenticazione SAML](./media/active-directory-saas-envoy-tutorial/ic776785.png "Autenticazione SAML")
    
    >[!NOTE]
    >il valore di Hello per l'ID di posizione HQ hello viene automaticamente generato da un'applicazione hello.
    
    a. In **impronta digitale** casella di testo, incollare hello **identificazione personale** valore del certificato, che è stato copiato dal portale di Azure.
    
    b. Incolla **SAML Single Sign-On Service URL** valore, che è stato copiato modulo hello Azure portale in hello **IDENTITY PROVIDER HTTP SAML URL** casella di testo.
...
Non sono presenti elementi di azione per si tooconfigure di provisioning dell'utente tooEnvoy. Quando un utente assegnato tenta toolog a Envoy mediante il pannello di accesso di hello, Envoy verifica l'esistenza di utente hello. Se l'account utente non è presente, Envoy lo crea automaticamente.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooEnvoy.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooEnvoy, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Envoy**.
...
Quando si fa clic su riquadro Envoy hello in hello Pannello di accesso, è necessario ottenere applicazione Envoy tooyour automaticamente firmato-on.
