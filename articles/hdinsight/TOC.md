...
#### [Utilizzare visualizzazione Hive hello](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Utilizzare gli strumenti di HDInsight hello per Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Usare Desktop remoto](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Utilizzare hello Console di Query](hdinsight-hadoop-use-hive-query-console.md)
...
### [Eseguire gli esempi di hello MapReduce](hdinsight-hadoop-run-samples-linux.md)
...
#### [Utilizzare hello .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Scrittura tooData Lake archivio](hdinsight-storm-write-data-lake-store.md)
...
### [Usare gli strumenti HDInsight toocreate Spark App](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Usare gli strumenti HDInsight toodebug Spark App in modalità remota tramite SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Connettere Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Connessione tramite driver JDBC Hive hello](hdinsight-connect-hive-jdbc-driver.md)
...
### [La connessione di rete locale tooyour di HDInsight](connect-on-premises-network.md)
...
#### [Usare le app tooinstall REST](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Pubblicare le app di HDInsight tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Proteggere
...
### [Limitare l'accesso toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Gestisci
...
#### [Usare cURL e hello API REST di Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Utilizzare hello .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Utilizzare hello CLI di Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Utilizzare hello portale di Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Utilizzare hello CLI di Azure](hdinsight-administer-use-command-line.md)
### [Gestire i cluster con hello Ambari web dell'interfaccia utente](hdinsight-hadoop-manage-ambari.md)
...
### [Eseguire la migrazione di strumenti di sviluppo tooResource Manager](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Disponibilità e affidabilità](hdinsight-high-availability-linux.md)
### [Aggiornare la versione toonewer cluster HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Utilizzare viste Ambari toodebug Tez processi](hdinsight-debug-ambari-tez-view.md)
...
# Risorse correlate
## Cluster Windows
### [Eseguire la migrazione di cluster tooLinux i cluster di Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Eseguire la migrazione di cluster tooLinux di soluzioni .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Usare i grafici di Giraph tooprocess su larga scala](hdinsight-hadoop-giraph-install.md)
...
### [Utilizzare le applicazioni Java di Maven toobuild](hdinsight-hbase-build-java-maven.md)
### [Utilizzare hello UI Tez toodebug Tez processi](hdinsight-debug-tez-ui.md)
...
### [Monitorare i cluster usando hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Risorse
## [Roadmap per Azure](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Ottenere informazioni sui forum hello](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
