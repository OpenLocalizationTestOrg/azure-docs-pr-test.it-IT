...
dispositivo StorSimple Hello ha due 100-240 v con doppia ventola e conformi a SBB raffreddamento moduli PCM (Power). Fornisce una configurazione di alimentazione ridondante. Caso di guasto di un PCM, dispositivo hello proseguirà normalmente toooperate in hello viene sostituito l'altro PCM finché hello non modulo.  
...
Si è ora pronto toodeploy un dispositivo StorSimple nel Data Center. Per altre informazioni, vedere [Distribuire un dispositivo StorSimple locale](storsimple-deployment-walkthrough-u2.md).  
