...
2.  <span data-ttu-id="9a61f-126">Digitare `dsregcmd.exe /debug /leave`.</span><span class="sxs-lookup"><span data-stu-id="9a61f-126">Type `dsregcmd.exe /debug /leave`</span></span>
