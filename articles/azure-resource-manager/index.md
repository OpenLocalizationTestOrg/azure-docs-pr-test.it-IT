        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni su Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Catalogo video di Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione ad Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione alla creazione di dipendenze nei modelli di Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione a più istanze di risorse in Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/resource">Interfaccia della riga di comando di Azure</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/templates/">Formato del modello</a></p>
                        <p><a href="/azure/resource-group-template-functions">Funzioni di modello</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-functions">Funzioni di definizione dell'interfaccia utente</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-elements">Elementi di definizione dell'interfaccia utente</a></p>
                    </div>
                </div>
            </div>
        </div>
