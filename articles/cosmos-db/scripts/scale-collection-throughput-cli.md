...
---
# <a name="scale-azure-cosmos-db-container-throughput-using-hello-azure-cli"></a>Velocità effettiva di contenitore Azure Cosmos DB scala utilizzando hello CLI di Azure
