...
* Il file `main.c` nella sottocartella `app` è il file di origine chiave. Questo file contiene il codice per inviare 20 volte un messaggio all'hub IoT e far lampeggiare il LED per ogni messaggio inviato.
...
[Eseguire un'applicazione di esempio per inviare messaggi da dispositivo a cloud](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)
