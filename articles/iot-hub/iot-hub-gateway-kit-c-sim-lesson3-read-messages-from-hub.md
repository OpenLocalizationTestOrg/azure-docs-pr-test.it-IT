...
La stringa di connessione del dispositivo viene usata dal dispositivo simulato per la connessione all'hub IoT. La stringa di connessione dell'hub IoT viene usata per connettersi al registro di identità nell'hub IoT per gestire i dispositivi che possono connettersi all'hub IoT.
