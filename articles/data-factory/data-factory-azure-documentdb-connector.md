...
1. **Domanda:** C’è l'aggiornamento del supporto di attività di copia dei record esistenti?
    ...
    **Risposta:** No.
2. **Domanda:** funzionamento un nuovo tentativo di una copia di database Cosmos Azure gestiscono già copiati i record?
...
3. **Domanda:** Data Factory supporta [intervallo o il partizionamento dei dati basati su hash](../documentdb/documentdb-partition-data.md)?

    **Risposta:** No.
4. **Domanda:** è possibile specificare più di una raccolta di Azure Cosmos DB per una tabella?
