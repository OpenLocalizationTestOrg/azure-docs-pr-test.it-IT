...
## [Eseguire la procedura guidata hello](/sql/sql-server/stretch-database/get-started-by-running-the-enable-database-for-stretch-wizard)
...
### [Selezionare le righe toomigrate](/sql/sql-server/stretch-database/select-rows-to-migrate-by-using-a-filter-function-stretch-database)
## Gestisci
