...
toolearn tooassign ruoli amministrativi tooa utente in Azure Active Directory, vedere [assegnare ruoli tooadministrator in anteprima di Azure Active Directory di un utente](active-directory-users-assign-role-azure-portal.md).
