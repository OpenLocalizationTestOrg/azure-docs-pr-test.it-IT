...
### [Selezionare il progetto API web toomy verificato anomalo](vs-active-directory-webapi-what-happened.md)
...
### [Chiamate al servizio tooservice](active-directory-protocols-oauth-service-to-service.md)
