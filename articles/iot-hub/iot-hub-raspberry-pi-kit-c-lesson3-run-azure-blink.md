...
In questo articolo verrà illustrato come toodeploy ed eseguire un'applicazione di esempio 3 Pi Raspberry che invia messaggi tooyour IoT hub. Se si verificano problemi, cercare soluzioni in hello [risoluzione dei problemi di pagina](iot-hub-raspberry-pi-kit-c-troubleshooting.md).
...
* Prima di iniziare questa attività, è necessario che sia completata [creare un'app di Azure (funzione) e un hub IoT tooprocess e l'archivio del account di archiviazione messaggi](iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template.md).
