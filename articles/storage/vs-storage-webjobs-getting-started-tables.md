...
Per ulteriori informazioni su come hello toouse **CloudTable** , vedere [Introduzione all'archiviazione tabelle di Azure usando .NET](storage-dotnet-how-to-use-tables.md).
