...
In questa esercitazione, è illustrato come toointegrate Greenhouse con Azure Active Directory (Azure AD).

Integrazione di Greenhouse con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooGreenhouse.
- È possibile abilitare l'utenti tooautomatically get connesso tooGreenhouse (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Greenhouse tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Greenhouse dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-greenhouse-from-hello-gallery"></a>Aggiunta di Greenhouse dalla raccolta hello
integrazione hello tooconfigure di Greenhouse in Azure AD, è necessario tooadd Greenhouse dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Greenhouse dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Greenhouse**selezionare **Greenhouse** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Greenhouse è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Greenhouse deve toobe stabilita.

In Greenhouse, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Greenhouse, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Greenhouse](#create-a-greenhouse-test-user)**  -toohave un equivalente di Britta Simon in Greenhouse che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Greenhouse.

**Azure AD tooconfigure single sign-on con Greenhouse, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Greenhouse** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Greenhouse dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **Sign-on URL** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<companyname>.greenhouse.io`

    b. In hello **identificatore** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<companyname>.greenhouse.io`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo URL di accesso e l'identificatore. Contatto [team di supporto di Greenhouse Client](https://www.greenhouse.io/contact) tooget questi valori. 
...
6. tooconfigure single sign-on sul **Greenhouse** lato, è necessario hello toosend scaricato **Metadata XML** troppo[team di supporto di Greenhouse](http://www.greenhouse.io/contact).
...
In ordine tooenable Azure AD utenti toolog a Greenhouse, è necessario eseguirne il provisioning in Greenhouse. Nel caso di hello di Greenhouse, il provisioning è un'attività manuale.

>[!NOTE]
>È possibile usare qualsiasi altro Greenhouse utente account strumento di creazione o le API fornite da Greenhouse tooprovision account utente di AAD. 

**eseguire un account utente, tooprovision hello i passaggi seguenti:**

1. Accedi tooyour **Greenhouse** sito aziendale come amministratore.

2. Scegliere dal menu hello in primo piano hello **configura**, quindi fare clic su **utenti**.
...
4. In hello **Add New User** seguire hello alla procedura seguente:
   ...
   a. In hello **immettere messaggi di posta elettronica utente** casella di testo, digitare hello di indirizzo di posta elettronica di un account Azure Active Directory valido, si desidera tooprovision.

   b. Fare clic su **Salva**.    
   
      >[!NOTE]
      >i titolari dell'account Azure Active Directory Hello riceverà un messaggio di posta elettronica tra un account di hello tooconfirm collegamento prima che diventi attivo.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooGreenhouse.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooGreenhouse, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Greenhouse**.
...
Quando si fa clic su riquadro Greenhouse hello in hello Pannello di accesso, è necessario ottenere applicazione Greenhouse tooyour automaticamente firmato-on.
