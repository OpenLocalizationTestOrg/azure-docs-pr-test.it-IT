...
In questa esercitazione, è illustrato come toointegrate DigiCert con Azure Active Directory (Azure AD).

Integrazione DigiCert con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooDigiCert
- È possibile abilitare l'utenti tooautomatically get connesso tooDigiCert (Single Sign-On) con i propri account Azure AD
...
integrazione di Azure AD con DigiCert tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di DigiCert dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-digicert-from-hello-gallery"></a>Aggiunta di DigiCert dalla raccolta hello
integrazione hello tooconfigure di DigiCert in Azure AD, è necessario tooadd DigiCert dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd DigiCert dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **DigiCert**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-digicert-tutorial/tutorial_digicert_search.png)

5. Nel riquadro dei risultati hello, selezionare **DigiCert**, quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in DigiCert è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in DigiCert deve toobe stabilita.

In DigiCert, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con DigiCert, è necessario hello toocomplete seguenti blocchi predefiniti:

1. **[Configurazione di Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable il toouse utenti questa funzionalità.
2. **[Creazione di un utente prova AD Azure](#creating-an-azure-ad-test-user)**  -tootest AD Azure single sign-on con Britta Simon.
3. **[Creazione di un utente test DigiCert](#creating-a-digicert-test-user)**  -toohave un equivalente di Britta Simon in DigiCert che è la rappresentazione toohello collegato Azure AD dell'utente.
4. **[Assegnazione utente di prova hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD accesso single sign-on.
5. **[Test di Single Sign-On](#testing-single-sign-on)**  -tooverify hello se funzionamento della configurazione.

### <a name="configuring-azure-ad-single-sign-on"></a>Configurazione dell'accesso Single Sign-On di Azure AD

In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione DigiCert.

**Azure AD tooconfigure single sign-on con DigiCert, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **DigiCert** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
5. In hello **gli attributi utente** sezione hello **Single sign-on** finestra di dialogo, configurare attributi token SAML, come illustrato nella figura hello ed eseguire hello alla procedura seguente:
    ...
    > [!Note]
    > valore di Hello **aziendale** attributo non è di tipo real. Aggiornare il valore con il codice società reale. valore hello tooget **aziendale** attributo contatto [team di supporto DigiCert](mailto:support@digicert.com).
...
8. tooconfigure single sign-on sul **DigiCert** lato, è necessario hello toosend scaricato **Metadata XML** troppo[team di supporto DigiCert](mailto:support@digicert.com). Impostano questo hello toohave impostazione connessione SAML SSO impostato correttamente su entrambi i lati.
...
In questa sezione si crea un utente con nome Britta Simon in DigiCert. Rivolgersi [team di supporto DigiCert](mailto:support@digicert.com) gli utenti di hello tooadd DigiCert.

### <a name="assigning-hello-azure-ad-test-user"></a>Assegnazione utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooDigiCert.

![Assegna utente][200] 

**tooassign Britta Simon tooDigiCert, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **DigiCert**.
...
Quando si fa clic su riquadro DigiCert hello in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour DeigiCert applicazione.
