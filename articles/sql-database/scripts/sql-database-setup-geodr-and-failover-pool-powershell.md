...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-pooled-azure-sql-database"></a>Utilizzare PowerShell tooconfigure replica geografica attiva per un database SQL di Azure in pool

In questo esempio di script di PowerShell consente di configurare la replica geografica attiva per un database SQL di Azure in un pool elastico e il failover toohello replica secondaria del database SQL di Azure hello.
...
| [Set-AzureRmSqlDatabaseSecondary](/powershell/module/azurerm.sql/set-azurermsqldatabasesecondary)| Attiva un database primario toobe database secondario in ordine di failover tooinitiate.|
