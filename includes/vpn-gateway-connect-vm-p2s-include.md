...
1. Individuare l'indirizzo IP privato hello. È possibile trovare l'indirizzo IP privato hello di una macchina virtuale, entrambi esaminando le proprietà di hello per macchina virtuale nel portale di Azure hello hello o tramite PowerShell.
