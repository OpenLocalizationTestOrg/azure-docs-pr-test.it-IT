...
Utilizzare un toocreate modello di gestione risorse di Azure un'app di Azure (funzione) e un account di archiviazione di Azure. app di Azure funzione Hello è in ascolto di eventi di hub IoT tooAzure, elabora i messaggi in arrivo e li scrive archiviazione tabella tooAzure. Se si verificano problemi, cercare soluzioni in hello [risoluzione dei problemi di pagina](iot-hub-raspberry-pi-kit-c-troubleshooting.md).
...
- [Introduzione a Raspberry Pi 3](iot-hub-raspberry-pi-kit-c-get-started.md)
- [Creare l'hub IoT di Azure](iot-hub-raspberry-pi-kit-c-get-started.md)
...
* Hello `main.c` file hello `app` sottocartella è il file di origine della chiave hello. Questo file di origine contiene toosend codice hello un messaggio di 20 volte tooyour IoT hub e blink hello LED per ogni messaggio inviato.
...
* Sostituire **[your IoT Hub name]** con il valore di **{my hub name}** specificato quando [è stato creato l'hub IoT ed è stato registrato il dispositivo Raspberry Pi 3](iot-hub-raspberry-pi-kit-c-lesson2-prepare-azure-iot-hub.md).
...
[Eseguire un toosend di applicazione di esempio i messaggi da dispositivo a cloud](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)
