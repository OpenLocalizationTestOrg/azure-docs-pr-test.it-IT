...
In questa esercitazione, è illustrato come toointegrate FM: Systems con Azure Active Directory (Azure AD).

Integrazione di FM: Systems con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooFM:Systems
- È possibile abilitare l'utenti tooautomatically get connesso tooFM:Systems (Single Sign-On) con i propri account Azure AD
...
integrazione di Azure AD con FM: Systems tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di FM: Systems dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-fmsystems-from-hello-gallery"></a>Aggiunta di FM: Systems dalla raccolta hello
integrazione hello tooconfigure di FM: Systems in Azure AD, è necessario tooadd FM: Systems dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd FM: Systems dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **FM: Systems**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fm-systems-tutorial/tutorial_fmsystems_search.png)

5. Nel riquadro dei risultati hello, selezionare **FM: Systems**, quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in FM: Systems è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in FM: Systems deve toobe stabilita.

In FM: Systems, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con FM: Systems, è necessario hello toocomplete seguenti blocchi predefiniti:

1. **[Configurazione di Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable il toouse utenti questa funzionalità.
2. **[Creazione di un utente prova AD Azure](#creating-an-azure-ad-test-user)**  -tootest AD Azure single sign-on con Britta Simon.
3. **[Creazione di un utente test FM: Systems](#creating-an-fmsystems-test-user)**  -toohave un equivalente di Britta Simon in FM: Systems che è la rappresentazione toohello collegato Azure AD dell'utente.
4. **[Assegnazione utente di prova hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD accesso single sign-on.
5. **[Test di Single Sign-On](#testing-single-sign-on)**  -tooverify hello se funzionamento della configurazione.

### <a name="configuring-azure-ad-single-sign-on"></a>Configurazione dell'accesso Single Sign-On di Azure AD

In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione FM: Systems.

**Azure AD tooconfigure single sign-on con FM: Systems, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **FM: Systems** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **URL e il dominio di FM: Systems** seguire hello alla procedura seguente:

    ![Configura accesso Single Sign-On](./media/active-directory-saas-fm-systems-tutorial/tutorial_fmsystems_url.png)

    In hello **URL di risposta** casella di testo, digitare il FM: Systems **URL di risposta**, digitare l'URL hello utilizzando hello seguente motivo:`https://<companyname>.fmshosted.com/fminteract/ConsumerService2.aspx`

    > [!NOTE] 
    > Poiché non è reale, Aggiornare questo valore con l'URL di risposta effettivo hello. Contatto [team di supporto di FM: Systems](https://fmsystems.com/ask-us/) tooget questo valore.
...
6. tooconfigure single sign-on sul **FM: Systems** lato, è necessario hello toosend scaricato **Metadata XML** troppo[team di supporto di FM: Systems](https://fmsystems.com/ask-us/). Impostano questo hello toohave impostazione connessione SAML SSO impostato correttamente su entrambi i lati. Una volta completata l'abilitazione dell'accesso Single Sign-On per la sottoscrizione, si riceverà una notifica.
...
2. Andare troppo**Amministrazione sistema \> Gestisci sicurezza \> utenti \> elenco utenti**.
...
4. In hello **Create User** seguire hello alla procedura seguente:
    ...
    a. Hello tipo **UserName**, hello **Password**, **Conferma Password**, **posta elettronica** e hello **ID dipendente**relative caselle di testo di un valido di Azure all'account di Active Directory desiderata tooprovision in hello.
   
    b. Fare clic su **Avanti**.

### <a name="assigning-hello-azure-ad-test-user"></a>Assegnazione utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooFM:Systems.

![Assegna utente][200] 

**tooassign Britta Simon tooFM:Systems, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **FM: Systems**.
...
Quando si fa clic su riquadro FM: Systems hello in hello Pannello di accesso, è necessario ottenere tooyour automaticamente firmato in FM: Systems applicazione.
