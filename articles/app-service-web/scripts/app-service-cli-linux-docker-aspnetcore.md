...
In questo scenario si apprenderà come pianificare e app web del servizio toocreate un gruppo di risorse, app di Linux e distribuire un'applicazione ASP.NET di base utilizzando un contenitore Docker.
