...
Questo script crea una macchina virtuale di Azure e quindi utilizza hello estensione Script personalizzata della macchina virtuale Azure tooinstall NGINX. Dopo l'esecuzione di script hello, è possibile accedere a un sito Web demo sull'indirizzo IP pubblico di hello della macchina virtuale hello.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Aggiungere una macchina virtuale VM estensione toohello. In questo esempio, un'estensione personalizzata hello è usato tooinstall NGINX. |
