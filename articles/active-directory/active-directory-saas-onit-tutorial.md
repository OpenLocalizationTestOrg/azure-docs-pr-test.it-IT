...
In questa esercitazione, è illustrato come toointegrate Onit con Azure Active Directory (Azure AD).

Integrazione di Onit con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooOnit.
- È possibile abilitare l'utenti tooautomatically get connesso tooOnit (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Onit tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Onit dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-onit-from-hello-gallery"></a>Aggiunta di Onit dalla raccolta hello
integrazione hello tooconfigure di Onit in Azure AD, è necessario tooadd Onit dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Onit dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Onit**selezionare **Onit** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Onit è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Onit richiede toobe stabilita.

In Onit, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Onit, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Onit](#create-an-onit-test-user)**  -toohave un equivalente di Britta Simon in Onit che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Onit.

**Azure AD tooconfigure single sign-on con Onit, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Onit** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Onit dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **Sign-on URL** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<sub-domain>.onit.com`

    b. In hello **identificatore** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<sub-domain>.onit.com`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo URL di accesso e l'identificatore. Contatto [team di supporto Client di Onit](https://www.onit.com/support) tooget questi valori. 
...
8. In hello **Onit configurazione** fare clic su **configurare Onit** tooopen **Configura sign-on** finestra. Hello copia **Sign-Out URL, SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**
...
10. Scegliere dal menu hello in primo piano hello **amministrazione**.
...
12. Fare clic su hello **sicurezza** scheda.
...
13. In hello **sicurezza** effettuare hello alla procedura seguente:
    ...
    b. In **Idp Target URL** casella di testo, hello Incolla valore **SAML Single Sign-On Service URL**, che è stato copiato dal portale di Azure.

    c. In **Idp logout URL** casella di testo, hello Incolla valore **Sign-Out URL**, che è stato copiato dal portale di Azure.

    d. In **Idp Cert Fingerprint (SHA1)** casella di testo, incollare hello **identificazione personale** valore del certificato, che è stato copiato dal portale di Azure.
...
In ordine tooenable Azure AD utenti toolog a Onit, è necessario eseguirne il provisioning in Onit.  

Nel caso di hello di Onit, il provisioning è un'attività manuale.

**tooconfigure provisioning degli utenti, eseguire hello alla procedura seguente:**

1. Accesso tooyour **Onit** sito aziendale come amministratore.
...
3. In hello **Aggiungi utente** finestra di dialogo eseguire hello alla procedura seguente:
  ...
  1. Hello tipo **nome** hello e **indirizzo di posta elettronica** di Azure un valido relative all'account di Active Directory desiderata tooprovision in hello nelle caselle di testo.
  2. Fare clic su **Crea**.    
...
In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooOnit.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooOnit, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Onit**.
...
Quando si fa clic su riquadro Onit hello in hello Pannello di accesso, è necessario ottenere l'applicazione Onit tooyour automaticamente firmato-on.
