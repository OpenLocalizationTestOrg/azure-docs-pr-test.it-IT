...
## [Eseguire la migrazione tooMyCloudIT](remoteapp-migrate-mycloudit.md)
## [Eseguire la migrazione tooCitrix informazioni Essentials](remoteapp-migrate-citrix.md)
...
### [Che cos'è immagine modello hello?](remoteapp-images.md)
...
### [Eseguire la migrazione tooan rete virtuale di Azure](remoteapp-migratevnet.md)
## Pubblicare applicazioni
### [Come toopublish un'app](remoteapp-publish.md)
## Gestire gli utenti
### [Come gli utenti tooadd](remoteapp-user.md)
### [Configurare Active Directory](remoteapp-ad.md)
### [Tenant di Azure AD hello modifica](remoteapp-changetenant.md)
