...
3. **Percorso UNC di hello copia dal riquadro "Connetti" hello nel portale di Azure hello**: una descrizione dettagliata delle modalità toofind queste informazioni sono reperibili [qui](storage-how-to-use-files-portal.md#connect-to-file-share).
