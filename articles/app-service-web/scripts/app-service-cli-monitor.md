...
| [az webapp log download](https://docs.microsoft.com/cli/azure/webapp/log#download) | Download hello registra di hello un computer locale di app tooyour web di Azure. |
