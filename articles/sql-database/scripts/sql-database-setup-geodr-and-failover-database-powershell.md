...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>Utilizzare PowerShell tooconfigure replica geografica attiva per un singolo database di SQL Azure

In questo esempio di script di PowerShell consente di configurare la replica geografica attiva per un singolo database di SQL Azure e il failover tooa replica secondaria del database SQL di Azure hello.
