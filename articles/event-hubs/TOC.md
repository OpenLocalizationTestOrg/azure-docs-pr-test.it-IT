...
## Acquisire eventi
### [Utilizzare hello Azure tooenable portale acquisire gli hub di eventi](event-hubs-capture-enable-through-portal.md)
### [Utilizzare un tooenable modello di gestione risorse acquisire gli hub di eventi](event-hubs-resource-manager-namespace-event-hub-enable-capture.md)
...
### [Utilizzando PowerShell tooprovision entità](event-hubs-manage-with-ps.md) 
