...
## Verificare tooand flussi IP da una macchina virtuale
...
## [Analizzare le anomalie toofind acquisizioni di pacchetti](network-watcher-deep-packet-inspection.md)
## [Utilizzare pacchetti acquisizione toodo attiva il monitoraggio della rete con le funzioni di Azure](network-watcher-alert-triggered-packet-capture.md)
