...
---
# <a name="query-data-from-the-azure-time-series-insights-environment-using-c"></a><span data-ttu-id="cda18-103">Eseguire query sui dati dell'ambiente Azure Time Series Insights tramite C#</span><span class="sxs-lookup"><span data-stu-id="cda18-103">Query data from the Azure Time Series Insights environment using C#</span></span>

<span data-ttu-id="cda18-104">Questo esempio in C# illustra come eseguire query sui dati dall'ambiente Azure Time Series Insights.</span><span class="sxs-lookup"><span data-stu-id="cda18-104">This C# example demonstrates how to query data from the Azure Time Series Insights environment.</span></span>
<span data-ttu-id="cda18-105">L'esempio mostra alcuni esempi di base relativi all'uso dell'API Query:</span><span class="sxs-lookup"><span data-stu-id="cda18-105">The sample shows several basic examples of Query API usage:</span></span>
1. <span data-ttu-id="cda18-106">Come passaggio preliminare, è necessario acquisire il token di accesso tramite l'API di Azure Active Directory.</span><span class="sxs-lookup"><span data-stu-id="cda18-106">As a preparation step, acquire the access token through the Azure Active Directory API.</span></span> <span data-ttu-id="cda18-107">Passare questo token nell'intestazione `Authorization` di ogni richiesta dell'API Query.</span><span class="sxs-lookup"><span data-stu-id="cda18-107">Pass this token in the `Authorization` header of every Query API request.</span></span> <span data-ttu-id="cda18-108">Per la configurazione di applicazioni non interattive, vedere [Autenticazione e autorizzazione](time-series-insights-authentication-and-authorization.md).</span><span class="sxs-lookup"><span data-stu-id="cda18-108">For setting up non-interactive applications, see [Authentication and authorization](time-series-insights-authentication-and-authorization.md).</span></span> <span data-ttu-id="cda18-109">Assicurarsi anche che tutte le costanti definite all'inizio dell'esempio siano impostate correttamente.</span><span class="sxs-lookup"><span data-stu-id="cda18-109">Also, ensure all the constants defined at the beginning of the sample are correctly set.</span></span>
2. <span data-ttu-id="cda18-110">Viene fornito l'elenco degli ambienti a cui l'utente può accedere.</span><span class="sxs-lookup"><span data-stu-id="cda18-110">The list of environments that the user has access to is obtained.</span></span> <span data-ttu-id="cda18-111">Uno degli ambienti viene selezionato come ambiente d'interesse e vengono eseguite altre query sui dati per questo ambiente.</span><span class="sxs-lookup"><span data-stu-id="cda18-111">One of the environments is picked up as the environment of interest, and further data is queried for this environment.</span></span>
3. <span data-ttu-id="cda18-112">Come esempio della richiesta HTTPS, vengono richiesti dati di disponibilità per l'ambiente di interesse.</span><span class="sxs-lookup"><span data-stu-id="cda18-112">As an example of HTTPS request, availability data is requested for the environment of interest.</span></span>
4. <span data-ttu-id="cda18-113">Come esempio della richiesta di Web Socket, vengono richiesti dati relativi alle aggregazioni di eventi per l'ambiente di interesse.</span><span class="sxs-lookup"><span data-stu-id="cda18-113">As an example of web socket request, event aggregates data is requested for the environment of interest.</span></span> <span data-ttu-id="cda18-114">Vengono richiesti dati per l'intero intervallo di tempo di disponibilità.</span><span class="sxs-lookup"><span data-stu-id="cda18-114">Data is requested for the whole availability time range.</span></span>

## <a name="c-example"></a><span data-ttu-id="cda18-115">Esempio in C#</span><span class="sxs-lookup"><span data-stu-id="cda18-115">C# example</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="cda18-116">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="cda18-116">Next steps</span></span>

<span data-ttu-id="cda18-117">Per informazioni di riferimento complete sull'API query, vedere il documento [Query API](/rest/api/time-series-insights/time-series-insights-reference-queryapi) (API query).</span><span class="sxs-lookup"><span data-stu-id="cda18-117">For the full Query API reference, see the [Query API](/rest/api/time-series-insights/time-series-insights-reference-queryapi) document.</span></span>
