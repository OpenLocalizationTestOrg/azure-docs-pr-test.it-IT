...
- Eseguire quindi un codice di esempio nel computer host per leggere i messaggi nell'archivio tabelle di Azure. 
...
- [Creazione dell'app per le funzioni di Azure e dell'account di archiviazione di Azure](iot-hub-gateway-kit-c-lesson4-deploy-resource-manager-template.md).
- [Esecuzione dell'applicazione di esempio gateway](iot-hub-gateway-kit-c-lesson3-configure-ble-app.md).
