...
In questa esercitazione, è illustrato come toointegrate Kantega SSO per JIRA con Azure Active Directory (Azure AD).

Integrazione Kantega SSO per JIRA con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooKantega SSO per JIRA
- È possibile abilitare l'utenti tooautomatically get connesso tooKantega SSO per JIRA (Single Sign-On) con i propri account Azure AD
...
integrazione di Azure AD con SSO Kantega per JIRA tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di SSO Kantega per JIRA dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-kantega-sso-for-jira-from-hello-gallery"></a>Aggiunta di SSO Kantega per JIRA dalla raccolta hello
integrazione hello tooconfigure di Kantega SSO per JIRA in Azure AD, è necessario tooadd Kantega SSO per JIRA dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Kantega SSO per JIRA dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Kantega SSO per JIRA**.
...
5. Nel riquadro dei risultati hello, selezionare **Kantega SSO per JIRA**, quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in SSO Kantega per JIRA è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in SSO Kantega per JIRA deve toobe stabilita.

In Kantega SSO per JIRA, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Kantega SSO per JIRA, è necessario hello toocomplete seguenti blocchi predefiniti:

1. **[Configurazione di Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable il toouse utenti questa funzionalità.
2. **[Creazione di un utente prova AD Azure](#creating-an-azure-ad-test-user)**  -tootest AD Azure single sign-on con Britta Simon.
3. **[Creazione di un SSO Kantega per utente test JIRA](#creating-a-kantega-sso-for-jira-test-user)**  -toohave un equivalente di Britta Simon Kantega SSO per JIRA che è la rappresentazione toohello collegato Azure AD dell'utente.
4. **[Assegnazione utente di prova hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD accesso single sign-on.
5. **[Test di Single Sign-On](#testing-single-sign-on)**  -tooverify hello se funzionamento della configurazione.

### <a name="configuring-azure-ad-single-sign-on"></a>Configurazione dell'accesso Single Sign-On di Azure AD

In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on in SSO il Kantega per applicazione JIRA.

**tooconfigure AD Azure single sign-on con SSO Kantega per JIRA, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Kantega SSO per JIRA** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In **IDP** avviato modalità, hello **Kantega SSO per dominio JIRA e gli URL** sezione eseguire hello seguente passaggio:
...
4. In **SP** modalità avviata, controllo **Mostra URL impostazioni avanzate** ed eseguire hello seguente passaggio:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo identificatore, l'URL di risposta e URL Sign-On. Questi valori vengono ricevuti durante la configurazione del plug-in Jira, illustrato più avanti nell'esercitazione di hello hello.
...
7. In una finestra del web browser, accedere come amministratore in tooyour JIRA nel server locale.
...
9. Nella sezione della scheda Add-ons (Componenti aggiuntivi) fare clic su **Find new add-ons** (Trova nuovi componenti aggiuntivi). Ricerca **Kantega SSO per JIRA (SAML & Kerberos)** e fare clic su **installare** tooinstall pulsante hello nuovo plug-in SAML.
...
13. Il nuovo plug-in è visualizzato in **INTEGRATIONS** (INTEGRAZIONI). Fare clic su **configura** tooconfigure hello nuovo plug-in.
...
16. In hello **proprietà App** sezione, eseguire la procedura seguente: 
    ...
    a. Hello copia **URI ID App** valore e utilizzarlo come **URL Sign-On, l'URL di risposta e identificatore** su hello **Kantega SSO per dominio JIRA e gli URL** sezione nel portale di Azure.
...
20. In hello **gli account utente JIRA** sezione, eseguire la procedura seguente:

    ![Configura accesso Single Sign-On](./media/active-directory-saas-kantegassoforjira-tutorial/addon10.png)

    a. Selezionare **creare gli utenti nella Directory interna del JIRA eventualmente** e immettere il nome appropriato del gruppo di hello hello per gli utenti (può essere più no. gruppi separati da virgola).
...
toolog agli utenti di Azure AD tooenable in tooJIRA, è necessario eseguirne il provisioning in JIRA. In Kantega SSO for JIRA il provisioning è un'attività manuale.

**tooprovision un account utente, eseguire hello alla procedura seguente:**

1. Accedere come amministratore tooyour JIRA nel server locale.
...
4. In hello **"Create new user"** finestra di dialogo eseguire hello alla procedura seguente:
...
In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooKantega SSO per JIRA.

![Assegna utente][200] 

**tooassign Britta Simon tooKantega SSO per JIRA, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Kantega SSO per JIRA**.
...
Quando si fa clic hello SSO Kantega riquadro JIRA in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour Kantega SSO per l'applicazione JIRA.
