...
Il ciclo di vita del TDSP è composto da cinque fasi principali che vengono eseguite in modo iterativo:
...
Gli obiettivi, le attività e gli elementi di documentazione per ogni fase del ciclo di vita del TDSP sono descritti nell'argomento [Ciclo di vita del processo di data science per i team](data-science-process-lifecycle.md). Queste attività ed elementi sono associati a ruoli di progetto:
