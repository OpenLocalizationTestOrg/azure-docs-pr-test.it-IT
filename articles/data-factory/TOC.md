# Panoramica
## [Introduzione tooAzure Data Factory](data-factory-introduction.md)
## Concetti
...
# Attività iniziali
## [Esercitazione: Creare una pipeline di dati toocopy](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)
...
## [Esercitazione: Creare una pipeline di dati tootransform](data-factory-build-your-first-pipeline.md)
...
#### [Procedura dettagliata: Spostare i dati da un tooAzure di SQL Server locale nell'archiviazione Blob](data-factory-move-data-between-onprem-and-cloud.md)
