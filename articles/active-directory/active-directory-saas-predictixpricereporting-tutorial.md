...
In questa esercitazione, è illustrato come toointegrate Predictix prezzo Reporting con Azure Active Directory (Azure AD).

Integrazione di Reporting di prezzo Predictix con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooPredictix prezzo Reporting.
- È possibile abilitare l'utenti tooautomatically get connesso tooPredictix prezzo Reporting (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Reporting prezzo Predictix tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Reporting di prezzo Predictix dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-predictix-price-reporting-from-hello-gallery"></a>Aggiunta di Reporting di prezzo Predictix dalla raccolta hello
integrazione hello tooconfigure di Predictix prezzo Reporting in Azure AD, è necessario tooadd Predictix prezzo Reporting dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Predictix prezzo Reporting dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Predictix prezzo Reporting**selezionare **Predictix prezzo Reporting** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Predictix prezzo Reporting è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure AD e l'utente correlato hello Predictix prezzo Reporting richiede toobe stabilita.

Predictix prezzo Reporting, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Predictix prezzo Reporting, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Reporting prezzo Predictix](#create-a-predictix-price-reporting-test-user)**  -toohave un equivalente di Britta Simon in Predictix prezzo Reporting che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Predictix prezzo Reporting.

**tooconfigure AD Azure single sign-on con Predictix prezzo Reporting, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Predictix prezzo Reporting** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Predictix prezzo Reporting dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **Sign-on URL** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<companyname-pricing>.predictix.com/sso/request`
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo URL di accesso e l'identificatore. Contatto [team di supporto Client di segnalazione errori prezzo Predictix](http://www.infor.com/company/customer-center/) tooget questi valori. 
...
6. In hello **configurazione di Reporting prezzo Predictix** fare clic su **configurare Reporting prezzo Predictix** tooopen **Configura sign-on** finestra. Hello copia **Sign-Out URL, l'ID entità SAML e SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**
...
In questa sezione viene creato un utente di nome Britta Simon in Predictix Price Reporting. Lavorare con [Predictix prezzo Reporting team di supporto](http://www.infor.com/company/customer-center/) utenti hello tooadd nella piattaforma di Reporting di prezzo Predictix hello.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooPredictix prezzo Reporting.

![Assegnazione del ruolo utente hello][200] 

**tooassign tooPredictix Britta Simon prezzo Reporting, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Predictix prezzo Reporting**.
...
Quando si fa clic su riquadro Predictix prezzo Reporting hello in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour Predictix prezzo Reporting applicazione.
