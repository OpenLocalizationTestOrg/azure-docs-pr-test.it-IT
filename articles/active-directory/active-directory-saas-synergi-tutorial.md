...
In questa esercitazione, è illustrato come toointegrate Synergi con Azure Active Directory (Azure AD).

Integrazione Synergi con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooSynergi.
- È possibile abilitare l'utenti tooautomatically get connesso tooSynergi (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con Synergi tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di Synergi dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-synergi-from-hello-gallery"></a>Aggiunta di Synergi dalla raccolta hello
integrazione hello tooconfigure di Synergi in Azure AD, è necessario tooadd Synergi dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd Synergi dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **Synergi**selezionare **Synergi** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in Synergi è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in Synergi deve toobe stabilita.

In Synergi, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con Synergi, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test Synergi](#create-a-synergi-test-user)**  -toohave un equivalente di Britta Simon in Synergi che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione Synergi.

**Azure AD tooconfigure single sign-on con Synergi, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **Synergi** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **Synergi dominio e gli URL** seguire hello alla procedura seguente:
    ...
    a. In hello **identificatore** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<company name>.irmsecurity.com`

    b. In hello **URL di risposta** casella di testo, digitare un URL utilizzando hello seguente modello:`https://<company name>.irmsecurity.com/sso/<organization id>`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con URL di risposta e identificatore effettivo hello. Contatto [team di supporto Synergi](https://www.irmsecurity.com/contact/) tooget questi valori.
...
6. In hello **Synergi configurazione** fare clic su **configurare Synergi** tooopen **Configura sign-on** finestra. Hello copia **Sign-Out URL e l'ID entità SAML** da hello **sezione di riferimento rapido.**

    ![Configurazione di Synergi](./media/active-directory-saas-synergi-tutorial/tutorial_synergi_configure.png) 

7. tooconfigure single sign-on sul **Synergi** lato, è necessario hello toosend scaricato **Certificate(Base64), Sign-Out URL e l'ID entità SAML** troppo[team di supporto Synergi](https://www.irmsecurity.com/contact/).
...
In questa sezione viene creato un utente chiamato Britta Simon in Synergi. Lavorare con [team di supporto Synergi](https://www.irmsecurity.com/contact/) per aggiungere gli utenti di hello nella piattaforma Synergi hello. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooSynergi.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooSynergi, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **Synergi**.
...
Quando si fa clic su riquadro Synergi hello in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour Synergi applicazione.
