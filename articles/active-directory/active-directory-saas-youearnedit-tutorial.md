...
In questa esercitazione, è illustrato come toointegrate YouEarnedIt con Azure Active Directory (Azure AD).

Integrazione YouEarnedIt con Azure AD fornisce hello seguenti vantaggi:

- È possibile controllare in Azure AD che ha accesso tooYouEarnedIt.
- È possibile abilitare l'utenti tooautomatically get connesso tooYouEarnedIt (Single Sign-On) con i propri account Azure AD.
...
integrazione di Azure AD con YouEarnedIt tooconfigure, è necessario hello seguenti elementi:
...
1. Aggiunta di YouEarnedIt dalla raccolta hello
2. Configurazione e test dell'accesso Single Sign-On di Azure AD

## <a name="adding-youearnedit-from-hello-gallery"></a>Aggiunta di YouEarnedIt dalla raccolta hello
integrazione hello tooconfigure di YouEarnedIt in Azure AD, è necessario tooadd YouEarnedIt dall'elenco di tooyour hello raccolta di App SaaS gestite.

**tooadd YouEarnedIt dalla raccolta di hello, eseguire hello alla procedura seguente:**
...
4. Nella casella di ricerca hello, digitare **YouEarnedt**selezionare **YouEarnedt** dal pannello risultati quindi fare clic su **Aggiungi** pulsante applicazione hello tooadd.
...
Per toowork di accesso singolo, Azure AD deve tooknow quale utente controparte hello in YouEarnedIt è tooa utente in Azure AD. In altre parole, una relazione di collegamento tra un utente di Azure Active Directory e l'utente correlato di hello in YouEarnedIt deve toobe stabilita.

In YouEarnedIt, assegnare il valore di hello di hello **nome utente** in Azure AD come valore hello hello **Username** tooestablish relazione di collegamento hello.

tooconfigure e prova AD Azure single sign-on con YouEarnedIt, è necessario hello toocomplete seguenti blocchi predefiniti:
...
3. **[Creare un utente test YouEarnedIt](#create-a-youearnedit-test-user)**  -toohave un equivalente di Britta Simon in YouEarnedIt che è la rappresentazione toohello collegato Azure AD dell'utente.
...
In questa sezione, si abilita Azure AD single sign-on in hello portale di Azure e configurare l'accesso single sign-on nell'applicazione YouEarnedIt.

**Azure AD tooconfigure single sign-on con YouEarnedIt, eseguire hello alla procedura seguente:**

1. Nel portale di Azure su hello hello **YouEarnedIt** pagina di integrazione dell'applicazione, fare clic su **Single sign-on**.
...
3. In hello **YouEarnedIt dominio e gli URL** seguire hello alla procedura seguente:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con hello effettivo URL di accesso e l'identificatore. Contatto [team di supporto YouEarnedIt Client](https://youearnedit.freshdesk.com/support/tickets/new) tooget questi valori. 
...
6. In hello **YouEarnedIt configurazione** fare clic su **configurare YouEarnedIt** tooopen **Configura sign-on** finestra. Hello copia **SAML Single Sign-On Service URL** da hello **sezione di riferimento rapido.**
...
In questa sezione viene creato un utente di nome Britta Simon in YouEarnedIt. Rivolgersi gli utenti YouEarnedIt supporto team tooadd hello nella piattaforma YouEarnedIt hello.

>[!NOTE]
>YouEarnedIt prevede che i Provider di identità di toosupply hello un EmailAddress o un nome utente nell'attributo NameID hello. L'autenticazione avrà esito negativo se un nome utente corrispondente EmailAddress non viene trovato all'interno del database hello o non corrisponde esattamente. Ciò richiede che gli account di essere importati nel sistema YouEarnedIt hello prima dell'integrazione di SSO hello (in genere tramite importazione API o CSV).

### <a name="assign-hello-azure-ad-test-user"></a>Assegnare l'utente test hello Azure AD

In questa sezione per abilitare Britta Simon toouse single sign-on Azure concessione dell'accesso tooYouEarnedIt.

![Assegnazione del ruolo utente hello][200] 

**tooassign Britta Simon tooYouEarnedIt, eseguire hello alla procedura seguente:**

1. Nel portale di Azure hello, aprire la visualizzazione di applicazioni hello, quindi selezionare Visualizza directory toohello e andare troppo**applicazioni aziendali** quindi fare clic su **tutte le applicazioni**.

    ![Assegna utente][201] 

2. Nell'elenco di applicazioni hello, selezionare **YouEarnedIt**.
...
Quando si fa clic su riquadro YouEarnedIt hello in hello Pannello di accesso, è necessario ottenere automaticamente firmato in tooyour YouEarnedIt applicazione.
